    ...
    <div class="parking">
        <div class="part">
            <div class="inner" style="margin: left 200px;">
                <form action="process-book-4.php" method="post">
                    <h4>State Date and Time to book</h4>
                    <hr>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">From: </label><br>
                        <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="from"placeholder="02.11.2014 11:05am"><br>
                        <label for="exampleInputEmail1" class="form-label">To: </label><br>
                        <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"name="to" placeholder="02.11.2014 12:05pm"><br>
                    </div>
