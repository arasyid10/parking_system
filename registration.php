			...
			<div class="form">
				...
				<table style="text-align: center;">
					...
					<form id="registration" method="post" action="register.php">
						...
						<input type="text" placeholder="Username" name="name" class="input"> <br><br>
						<input type="email" placeholder="Email address" name="email" class="input"> <br><br>
						<input type="Password" placeholder="Password" name="password" class="input"> <br><br>
						<input type="number" placeholder="Phone Number" name="phone" class="input"> <br><br>

						<button type="submit" id="btn" name="register">Register</button>
						<br><br>
						<a class="link" href="user_login.php">Already have an account</a>
						<br><br>
