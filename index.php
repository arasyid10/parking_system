...
<head>
    ...
    <title>Intelli Parking System</title>
...
<body data-spy="scroll" data-target=".fixed-top">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <a class="btn-solid-lg page-scroll" href="user_login.php">Reserve Spot</a>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1>🚗+👉🏼=😊</h1>
                    <a class="btn-solid-lg page-scroll" href="user_login.php">Ready to book?🤔</a>
                </div>
                <!-- end of col -->
            </div>
            <!-- end of row -->
    ...
    <div id="contact" class="form-1" style="background: url('images/illumeni_header_bg.jpeg') center center no-repeat;  background-size:cover;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Reach Out</h2>
