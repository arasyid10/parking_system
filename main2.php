                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown01">
                            <a class="dropdown-item page-scroll" href="sucess_login.php">Online Booking</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item page-scroll" id="payment1" href="sucess_login.php">Payment Methods</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item page-scroll" href="sucess_login.php">Our Team</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item page-scroll" href="sucess_login.php">Security</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="sucess_login.php">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="sucess_login.php">Contact</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="sucess_login.php" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Parking Zones</a>
                        <div class="dropdown-menu" aria-labelledby="dropdown01">
