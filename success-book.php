    ...
    <div class="parking">
        <div class="part">
            <div class="inner" style="margin: left 200px;">
                <form action="process-book-3.php" method="post">
                    <h4>Success </h4>
                    <hr>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Parking Lot Reserved!</label><br>
                        <label for="exampleInputEmail1" class="form-label">Thank you for using the system!</label><br>
                    </div>
