    ...
    <div class="parking">
        <div class="part">
            <div class="inner" style="margin: left 200px;">
                <form action="process-mpesa.php" method="post">
                    <h4>Payment</h4>
                    <hr>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="mphone" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="eg.0791498056"><br>
                        <label for="exampleInputEmail1" class="form-label">Pin</label>
                        <input type="password" name="mpin"class="form-control" id="exampleInputEmail1" type="number" name="date">
